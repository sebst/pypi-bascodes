...
def get_version():
    main_file = os.path.join(CURDIR, "bascodes", "main.py")
...
setup(
    ...
    version=get_version(),
    author="Bas Steins",
    author_email="blog@bascodes.com",
    description="Bas Steins – Terminal Card",
    ...
    keywords=[],
    scripts=[],
    entry_points={"console_scripts": ["bascodes = bascodes.__main__:main"]},
    zip_safe=False,
